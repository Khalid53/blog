...
if (isset($_POST['btn'])) {
    ...
    $message=$category->saveAllCategory($_POST);
}
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" name="category_description" class="form-control" id="inputPassword3" placeholder="category description"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
